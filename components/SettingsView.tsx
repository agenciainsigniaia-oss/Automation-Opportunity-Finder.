...
export const SettingsView: React.FC<SettingsProps> = ({ isDarkMode, toggleTheme }) => {
  return (
    <div className="max-w-2xl mx-auto animate-fade-in text-text-main">
      <h1 className="text-3xl font-bold mb-8">Configuración</h1>

      <div className="bg-surface rounded-2xl border border-gray-200 dark:border-surfaceHighlight overflow-hidden">
        <div className="p-6 border-b border-gray-200 dark:border-surfaceHighlight">
          <h2 className="text-lg font-semibold">Apariencia</h2>
          <p className="text-sm text-text-muted">Personaliza cómo se ve AutoFinder.</p>
        </div>
        ...
        <div className="p-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-text-muted">Alternar entre temas claro y oscuro.</p>
            </div>
          </div>
